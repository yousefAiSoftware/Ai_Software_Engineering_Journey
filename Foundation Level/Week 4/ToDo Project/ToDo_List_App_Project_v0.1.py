...
user_ToDo_list = []
# I should print the user ToDo list like this : 1. task1 \n 2. task2 using for loop with enumerate()
script_dir = os.path.dirname(os.path.abspath(__file__))
json_filename = os.path.join(script_dir,"ToDo Tasks.json")
def Menu():
